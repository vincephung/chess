...
public class Board {
    ...
    public Board() {
        ...
        board[7][0] = new Square(0, 0, new Rook("b"));
        board[7][1] = new Square(0, 1, new Knight("b"));
        board[7][2] = new Square(0, 2, new Bishop("b"));
        board[7][3] = new Square(0, 3, new Queen("b"));
        board[7][4] = new Square(0, 4, new King("b"));
        board[7][5] = new Square(0, 5, new Bishop("b"));
        board[7][6] = new Square(0, 6, new Knight("b"));
        board[7][7] = new Square(0, 7, new Rook("b"));
